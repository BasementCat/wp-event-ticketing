<?php
/*
Plugin Name: GFM Event Registration
Plugin URI: http://9seeds.com/plugins/
Description: The WP Event Ticketing plugin makes it easy to sell and manage tickets for your event. This is a slightly modified version for use in convention registration.
Author: 9seeds.com
Version: 1.3.3
...
echo '</div>';
	...
	function shortcode()
	{
		...
		else
		{
			...
			if (isset($_SESSION["ticketingError"]) && strlen($_SESSION["ticketingError"]))
			{
